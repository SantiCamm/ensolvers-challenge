...
import { useUncontrolled, clamp, mergeRefs } from '@mantine/hooks';
...
const Tabs = forwardRef((_a, ref) => {
  ...
  const panes = tabs.map((tab, index) => /* @__PURE__ */ React.createElement(TabControl, __spreadProps(__spreadValues({}, tab.props), {
    key: index,
