...
const Tabs = React.forwardRef((_a, ref) => {
  ...
  const panes = tabs.map((tab, index) => /* @__PURE__ */ React__default.createElement(TabControl.TabControl, __spreadProps(__spreadValues({}, tab.props), {
    key: index,
...
Tabs.Tab = TabControl.TabControl;
